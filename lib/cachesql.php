<?php
    ...
    class Cachesql
    {
        ...
        public function keys($pattern = '*')
        {
            ...
            $q          = "SELECT k FROM " . $this->table . " WHERE k LIKE '$pattern'";
        ...
        {
            return $this->q("DELETE FROM " . $this->table . " WHERE k = " . $this->quote($k));
        }

        private function _put($k, $v, $e)
        {
            $q = "INSERT INTO " . $this->table . " (k, v, e)
                VALUES (
                    " . $this->quote($k) . ",
                    " . $this->quote($v) . ",
                    " . $this->quote($e) . "
        ...
        {
            $q          = "SELECT v,e FROM " . $this->table . " WHERE k = " . $this->quote($k);
            $res        = $this->q($q)->fetch();
        ...
        {
            $q          = "SELECT k FROM " . $this->table . " WHERE k = " . $this->quote($k);
            $res        = $this->q($q)->fetch();
